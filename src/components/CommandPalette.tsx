...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = useMemo(() => [
    ...
    },
    {
      ...
      description: 'Track grading submissions and centering',
      icon: Award,
      action: () => navigate('/grading'),
      keywords: ['psa', 'bgs', 'cgc', 'slab', 'grade', 'centering'],
    },
    {
      id: 'trading',
      label: 'Trading Hub',
      description: 'Find trades and evaluate deals',
      icon: ArrowRightLeft,
      action: () => navigate('/trading'),
      keywords: ['trade', 'swap', 'exchange'],
    },
    {
      id: 'ebay',
      label: 'eBay Listings',
      ...
      icon: ShoppingCart,
      action: () => navigate('/ebay/listings'),
      keywords: ['ebay', 'listing', 'sell'],
    },
    {
      id: 'tax',
      label: 'Tax Reports',
      description: 'Generate tax reports for your sales',
      icon: FileText,
      action: () => navigate('/tax'),
      keywords: ['tax', 'report', 'irs', '1099'],
    },
    {
      id: 'goals',
      label: 'Goals',
    ...
    },
    {
      id: 'import',
      label: 'Import Cards',
      description: 'Import cards from CSV or other apps',
      icon: Upload,
      action: () => navigate('/import'),
      keywords: ['import', 'csv', 'upload', 'migrate'],
    },
    {
      id: 'leaderboards',
      label: 'Leaderboards',
      description: 'See top collectors',
      icon: Trophy,
      action: () => navigate('/leaderboards'),
      keywords: ['rank', 'top', 'leaderboard'],
    },
  ], [navigate]);
